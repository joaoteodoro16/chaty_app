...
class ChatProvider {
  ...
  static Widget get provider => MultiProvider(
    providers: [
      ...
      Provider<SendMessageUsecase>(create: (context) => SendMessageUsecaseImpl(repo: context.read()),),
      Provider<WatchMessagesUsecase>(create: (context) => WatchMessagesUsecaseImpl(repo: context.read()),),
      BlocProvider(create: (context) => ChatCubit(watchMessagesUsecase: context.read(), sendMessageUsecase: context.read()),)
    ],
    child: ChatPage(),
  );
}
