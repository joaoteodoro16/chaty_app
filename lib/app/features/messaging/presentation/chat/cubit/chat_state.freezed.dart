...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String conversationId,  List<Message> messages)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InitialState() when initial != null:
return initial();case _LoadingState() when loading != null:
return loading();case _LoadedState() when loaded != null:
return loaded(_that.conversationId,_that.messages);case _ErrorState() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String conversationId,  List<Message> messages)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _InitialState():
return initial();case _LoadingState():
return loading();case _LoadedState():
return loaded(_that.conversationId,_that.messages);case _ErrorState():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String conversationId,  List<Message> messages)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _InitialState() when initial != null:
return initial();case _LoadingState() when loading != null:
return loading();case _LoadedState() when loaded != null:
...
class _InitialState implements ChatState {
   _InitialState();
...
class _LoadingState implements ChatState {
   _LoadingState();
...
class _LoadedState implements ChatState {
   _LoadedState({required this.conversationId, required final  List<Message> messages}): _messages = messages;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoadedState&&(identical(other.conversationId, conversationId) || other.conversationId == conversationId)&&const DeepCollectionEquality().equals(other._messages, _messages));
}
...
@override
String toString() {
  return 'ChatState.loaded(conversationId: $conversationId, messages: $messages)';
}
...
/// @nodoc
abstract mixin class _$LoadedStateCopyWith<$Res> implements $ChatStateCopyWith<$Res> {
...
class _ErrorState implements ChatState {
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $ChatStateCopyWith<$Res> {
