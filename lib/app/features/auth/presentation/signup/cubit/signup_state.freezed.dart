...
class _InitialState implements SignupState {
   _InitialState();
...
class _LoadingState implements SignupState {
   _LoadingState();
...
class _LoadedState implements SignupState {
   _LoadedState();
...
class _ErrorState implements SignupState {
...
/// @nodoc
abstract mixin class _$ErrorStateCopyWith<$Res> implements $SignupStateCopyWith<$Res> {
