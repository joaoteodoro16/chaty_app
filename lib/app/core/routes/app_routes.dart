...
import 'package:chaty_app/app/features/messaging/di/chat_provider.dart';
...
import 'package:chaty_app/app/features/messaging/di/inbox_provider.dart';
...
class AppRoutes {
  ...
  static Map<String, Widget Function(BuildContext)> get routes => {
    ...
    conversationsPageRoute: (context) => InboxProvider.provider,
